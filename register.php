    ...
    <div class="container p-10">
        <div class=" bg-orange-100 rounded-lg h-700 p-10 drop-shadow-lg">
            <div class="max-w-md w-full mx-auto bg-white rounded-lg overflow-hidden shadow-2xl">
                ...
                <div class="p-8">
                <?php
    // Display any error messages from register_process.php 
    if (isset($_SESSION['error'])) {
        echo "<p class='text-center text-red-500 mb-2'>" . $_SESSION['error'] . "</p>";
        unset($_SESSION['error']); // Clear error after displaying
    }
    ?>
                    <form method="POST" onsubmit="return validatePasswords()" action="auth.php">
                        ...
                        <label for="text" class="block w-full ml-5 mb-1 text-sm font-medium text-gray-600">Last name </label>
                            ...
                            <input type="text" name="fname" class="block w-full p-3 mr-2 rounded bg-gray-200 border border-transparent focus:outline-none required">
                            <input type="text" name="lname" class="block w-full p-3 ml-2 rounded bg-gray-200 border border-transparent focus:outline-none required">
                            </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="phone" class="block w-full p-3 rounded bg-gray-200 border border-transparent focus:outline-none required">
                        </div>
                        <div class="mb-3">
                    ...
                    <p class="font-medium text-black text-center mt-5"> <a href="login.php">Have an account ?</p>
